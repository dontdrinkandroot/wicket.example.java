...
import net.dontdrinkandroot.example.wicket.dontdrinkandroot.page.bootstrap.IconPage;
import net.dontdrinkandroot.example.wicket.dontdrinkandroot.page.component.CalendarPage;
import net.dontdrinkandroot.example.wicket.dontdrinkandroot.page.component.FragmentBorderPage;
import net.dontdrinkandroot.example.wicket.dontdrinkandroot.page.component.LifecyclePage;
import net.dontdrinkandroot.example.wicket.dontdrinkandroot.page.component.PageHeightScalingPage;
import net.dontdrinkandroot.example.wicket.dontdrinkandroot.page.cookie.CookiePage;
import net.dontdrinkandroot.example.wicket.dontdrinkandroot.page.event.EventPage;
